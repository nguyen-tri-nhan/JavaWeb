...
public class UpdateCartController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for (BookDTO dto : cartdto.getCart().values()) {
                if (dto.getBookcode().equals(code)) {
                    ...
                    newBook = new BookDTO(code, title, author, publisher, language, genre, price, quantity, true);
                }
            }
            cartdto.update(code, newBook);
