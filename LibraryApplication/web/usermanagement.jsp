        ...
        <table border="1">
            ...
            <form action="MainController" method="POST">
                <tr>
                    ...
                    <td><input type="text" name="txtNewRole" value="${param.txtNewRole}"/></td>
                    <td>
                        <input type="submit" value="InstantCreate" name="btnAction"/>
                ...
                <tbody>
                    ...
                    <form action="MainController" method="POST">
                        <tr>
                            ...
                            <td>
                                <input type="submit" value="UpdateUser" name="btnAction" />
                                <input type="hidden" name="txtSearch" value="${param.txtSearch}"/>
                            </td>
                        </tr>
                    </form>
